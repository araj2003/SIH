...
const PatientForm = () => {
  ...
  return (
    <div>
      ...
      <label>
        current Medicine:
        <input type="text" value={currMed} onChange={(e) => setCurrMed(e.target.value)} />
      </label>
      <label>
        Exercise:
        <input type="text" value={exercise} onChange={(e) => setExersice(e.target.value)} />
      </label>
      <label>
        Diet:
      ...
      <label>
        Do You Smoke:
        <input type="text" value={smoke} onChange={(e) => setSmoke(e.target.value)} />
      </label>
      <label>
        Alcohol Consumption:
        <input type="text" value={alcohol} onChange={(e) => setAlcohol(e.target.value)} />
      </label>
      <label>
        Bp :
        <input type="text" value={bpLog} onChange={(e) => setBpLog(e.target.value)} />
      </label>
      <label>
        Glucose Level:
